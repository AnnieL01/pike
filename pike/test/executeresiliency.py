...
class TimeoutResiliency(test.PikeTest):
    ...
    def test_resiliency(self,durable=True):
        ...
        # resiliency invalidate, fh2 only read
        ...
        # resiliency invalidate, fh3 get the fh1's lease, and only read
    ...
    def test_timeout_resiliency(self,durable=True):
        ...
        self.assertEqual(fh2.lease.lease_state, self.rw)  # fh2 could get the lease
        chan2.close(fh2)
        chan2.connection.close()
    ...
    def test_buffer_too_small(self,durable=True):
        ...
        with self.assert_error(pike.ntstatus.STATUS_INVALID_PARAMETER): # for win
